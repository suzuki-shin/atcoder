...
i --------------
0  | 0 0 0 0 0 0 => row0
1 t| 0 0 0 0 1 1 => row1
2 o| 0 0 0 1 1 2 => row2
3 k| 0 1 1 1 1 2 => row3
4 y| 0 1 2 2 2 2 => row4
5 o| 0 1 2 3 3 3 => row5

-> row0 =               [0,0,0,0,0,0]
-> row1 = step row0 1 = [0,0,0,0,1,1]
